...
const config = {
  ...
  intro: {
    ...
    paragraphs: [
      ...
      "From full roof replacements to new construction installations, our Master Elite certified team works with you to select the perfect roofing system for your home's architecture, your budget, and Houston's demanding climate.",
  ...
  faqs: [
    ...
    { question: "What is the GAF Master Elite certification?", answer: "GAF Master Elite is the highest contractor certification awarded by GAF, North America's largest roofing manufacturer. Only 3% of roofing contractors nationwide earn this designation. It ensures you get access to the best warranties and materials available." },
